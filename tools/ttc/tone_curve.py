...
It is not a plain gamma - a gamma fit is decent in the midtones and badly wrong in the shadows
(16 -> 30 measured, 49 predicted), so the table is the honest representation.

Matching it matters: the Aerofly engine is the consumer and IPACS wrote both ends, so a tile
built without this curve renders darker than every tile the user already has installed.
"""

# index = source value, value = what GeoConvert writes
TONE_CURVE = [
