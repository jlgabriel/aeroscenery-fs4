    ...
    public class GMapProviderHelper
    {
        public static GMapProvider GetGMapProvider(string gmapProviderName)
        {
            switch (gmapProviderName)
            {
                ...
                //#MOD_l
                // Was mapped to OpenStreet4UMap under #MOD_f, on the belief that Open Street Map no
                // longer worked. b.tile.openstreetmap.org serves fine; 4umaps.eu is the one that is
                // gone (403). "OpenCycleMap" above still restores for anyone who saved that.
                case "OpenStreetMap":
